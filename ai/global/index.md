...
| [dotnet.instructions.md](dotnet.instructions.md) | .NET-specific: build and test before commit (`dotnet build`/`dotnet test`), solution structure, test assembly naming, FunFair.Test.Common, FunFair.BuildCheck, ValueTask preference, CancellationToken propagation, project-level NuGetAuditSuppress (no global NU19xx suppression) |
